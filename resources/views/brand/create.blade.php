    ...
    <div class="container my-5">
        <div class="row g-5 align-items-center d-flex justify-content-center">
            <div class="col-lg-8 mt-2 my-5">
                <h1 class="h3">Créer une nouvelle Marque</h1>
                @if ($errors->any())
                ...
                <form action="{{ route('brand.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="name" value="{{@old('name')}}" class="form-control mb-2 fs-4" placeholder="Marque...">
                    ...
                    <button class="btn btn-primary w-100">Créer une Marque</button>
                </form>
            </div>
        </div>
    </div>
